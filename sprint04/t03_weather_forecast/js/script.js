fetch(
    "http://api.openweathermap.org/data/2.5/onecall?lat=50.45466&lon=30.5238&lang=eu&appid=8dff50be2c3d057256c433410b7a89d0"
 )
    .then((response) => {
       return response.json();
    })
    .then((data) => {
       let weather = new Weather("weather", "Europe/Kharkiv");
       for (let i = 0; i < 7; i++) {
          weather.add(data, i);
       }
    });
